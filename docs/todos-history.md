# TODO history through 2026-09-07

Archived intact during the 2026-09-07 refactor. This file contains historical
observations, duplicate tasks, superseded priorities and old release instructions.
Unchecked boxes are not evidence that a defect still exists. Start with
[the current TODOs](todos.md) and verify historical findings against code before
resuming them. The current product direction is [product-vision.md](product-vision.md).

---

# Original running work list
